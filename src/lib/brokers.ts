...
export const brokers: Record<BrokerId, Broker> = {
  midasfx: {
    ...
    cons: [
      "Offshore broker (no major regulation)",
  ...
  n1cm: {
    ...
    paymentMethods: ["Crypto", "E-Wallets"],
    cryptoDeposits: true,
    negativeBalanceProtection: true,
    scores: {
  ...
  hfm: {
    ...
    spreads: "0.0 pips",
    spreadsFrom: 0,
    regulation: "CySEC, FCA, DFSA, FSCA, CMA, FSA",
    headquarters: "Cyprus",
    foundedYear: 2010,
    usAccepted: false, // Will update after confirmation
    platforms: ["MT4", "MT5", "HFM App"],
    accountTypes: ["Cent", "Premium", "Pro", "Zero Spread", "HFcopy"],
    ...
    scores: {
      ...
      platformTools: 4.2,
      customerSupport: 4.0,
      depositWithdrawal: 4.2,
      trustReputation: 4.2,
    },
    pros: [
      "Multi-regulated broker (CySEC, FCA + 4 more)",
  ...
  fxpro: {
    ...
    accountTypes: ["Standard", "Raw+", "Elite", "cTrader"],
  ...
  forexcom: {
    ...
    foundedYear: 2001,
    usAccepted: true,
    platforms: ["Forex.com Platform", "MT4", "MT5", "TradingView", "NinjaTrader"],
    accountTypes: ["Standard", "RAW Spread", "DMA"],
    paymentMethods: ["Wire Transfer", "ACH", "Credit Card"],
    cryptoDeposits: false,
    negativeBalanceProtection: true,
    scores: {
    ...
    cons: [
      "Limited leverage (1:50)",
      "RAW account has $7/lot commission",
  ...
  coinexx: {
    ...
    platforms: ["MT4", "MT5"],
    accountTypes: ["ECN"],
    paymentMethods: ["Bitcoin", "Ethereum", "USDT", "Litecoin", "USDC"],
    cryptoDeposits: true,
    negativeBalanceProtection: true,
    scores: {
      tradingConditions: 4.0,
  ...
  plexytrade: {
    ...
    accountTypes: ["Micro", "Silver", "Gold Raw", "Platinum"],
  ...
  fxtm: {
    ...
    spreads: "0.0 pips",
    spreadsFrom: 0,
    regulation: "FSC Mauritius, FSCA",
    headquarters: "Mauritius",
    foundedYear: 2011,
    usAccepted: false,
    platforms: ["MT4", "MT5", "FXTM Trader"],
    accountTypes: ["Edge", "Advantage", "Advantage Plus"],
    paymentMethods: ["Credit Card", "Wire Transfer", "Skrill", "Neteller"],
    cryptoDeposits: false,
    negativeBalanceProtection: true,
    scores: {
  ...
  avatrade: {
    ...
    spreads: "0.9 pips",
    spreadsFrom: 0.9,
    regulation: "ASIC, CIRO, JFSA, EU MiFID",
    headquarters: "Ireland",
    foundedYear: 2006,
    usAccepted: false,
    platforms: ["AvaTradeGO", "MT4", "MT5", "TradingView"],
    accountTypes: ["Retail", "Professional"],
    paymentMethods: ["Credit Card", "Wire Transfer", "Skrill", "Neteller"],
    cryptoDeposits: false,
    negativeBalanceProtection: true,
