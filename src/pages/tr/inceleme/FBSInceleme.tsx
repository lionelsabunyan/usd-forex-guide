        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="flex items-center justify-center gap-4 mb-4">
              <img src="/images/brokers/fbs.svg" alt="FBS" className="h-10" width={120} height={40} loading="lazy" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="p-6 bg-primary/5 border border-primary/20 rounded-2xl text-center">
              <p className="text-foreground font-semibold mb-2">
                FBS, bonus kampanyalarıyla öne çıkan popüler brokerlardan biri
              </p>
              <p className="text-sm text-muted-foreground mb-4">
                $1 minimum depozito · 1:3000 kaldıraç · Türkçe destek
              </p>
              <Button size="lg" asChild>
                <a href={broker.siteUrl} target="_blank" rel="noopener noreferrer"
                   onClick={() => trackTRBrokerClick("fbs", "tr_review_pros_cons", "hesap_ac")}>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-3 gap-3 mt-6 mb-6">
              <div className="p-3 bg-green-50 dark:bg-green-950/30 rounded-lg border border-green-200 dark:border-green-800">
                ...
                <p className="text-xs text-green-600 dark:text-green-500">Yeni başlayanlar<br/>Bonus arayanlar</p>
              </div>
              <div className="p-3 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-800">
                <p className="text-xs font-semibold text-blue-700 dark:text-blue-400 mb-1">⚡ İdeal</p>
                <p className="text-xs text-blue-600 dark:text-blue-500">Yüksek kaldıraç<br/>arayanlar</p>
              </div>
              <div className="p-3 bg-red-50 dark:bg-red-950/30 rounded-lg border border-red-200 dark:border-red-800">
                <p className="text-xs font-semibold text-red-700 dark:text-red-400 mb-1">❌ Uygun Değil</p>
                <p className="text-xs text-red-600 dark:text-red-500">Tier-1 regülasyon<br/>arayanlar</p>
              </div>
            </div>

            <div className="mt-2">
              <Button size="lg" asChild>
                <a href={broker.siteUrl} target="_blank" rel="noopener noreferrer" onClick={() => trackTRBrokerClick("fbs", "tr_review_bottom", "hesap_ac")}>
                  FBS'de Hesap Aç <ExternalLink className="w-4 h-4 ml-2" />
                </a>
              </Button>
            </div>
