...
import { Star, ExternalLink, Check, X, Users } from "lucide-react";
...
const EToroInceleme = () => {
  const broker = brokers.etoro;
  const overallRating = 4.0;

  useEffect(() => {
    trackTRPageView("etoro", "review");
  }, []);

  const ratings = [
    { label: "İşlem Koşulları", score: 3.5 },
  ...
  const pros = [
    "Sosyal/copy trading özelliği (CopyTrader)",
    "Çoklu regülasyon (FCA, CySEC, ASIC)",
    "Kullanımı çok kolay platform",
    "Kripto, hisse, ETF ve forex tek platformda",
    "PayPal ile para yatırma desteği",
    "$50 minimum depozito",
    "Sanal portföy (demo hesap)",
    "20 milyon+ kullanıcı topluluğu",
  ];

  const cons = [
    "Spread'ler bazı rakiplerden yüksek",
    "Para çekme ücreti ($5)",
    "MT4/MT5 desteği yok",
    "ABD'de sınırlı hizmet (yalnızca kripto)",
    "İnaktivite ücreti uygulanabilir",
  ];

  return (
    <TRLayout
      title="eToro İnceleme 2026 - Sosyal Trading Platformu"
      description="eToro broker detaylı inceleme. Sosyal/copy trading, $50 minimum depozito, FCA ve CySEC regülasyonlu. Kripto, hisse ve forex tek platformda."
      keywords="etoro broker, etoro inceleme, etoro türkiye, etoro copy trading, sosyal trading"
    >
      {/* Hero Section */}
            ...
            <div className="flex flex-col lg:flex-row items-start gap-8">
              <div className="flex-1">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-4">
                  ...
                  <span className="text-sm text-primary font-medium">Sosyal Trading Lideri</span>
                </div>

                <div className="flex items-center gap-4 mb-4">
                  <BrokerLogo broker={broker} className="w-20 h-20 rounded-2xl" imgClassName="p-2" />
                  <div>
                    <h1 className="font-heading text-3xl md:text-4xl font-bold text-foreground">eToro İnceleme</h1>
                    <p className="text-muted-foreground mt-1">20M+ kullanıcılı sosyal trading platformu</p>
                  </div>
                </div>
                ...
                <p className="text-muted-foreground mb-6">
                  eToro, 2007'de kurulan ve sosyal trading kavramını popülerleştiren öncü bir platformdur.
                  CopyTrader özelliği sayesinde başarılı yatırımcıların işlemlerini otomatik olarak
                  kopyalayabilirsiniz. Forex, hisse, kripto ve ETF'leri tek platformda sunar.
                </p>

                <div className="flex flex-wrap gap-3">
                  <Button size="lg" asChild>
                    <a href={broker.siteUrl} target="_blank" rel="noopener noreferrer" onClick={() => trackAffiliateClick("etoro", "tr_review_hero", "visit_site")}>
                      eToro'yu Ziyaret Et <ExternalLink className="w-4 h-4 ml-2" />
                    </a>
                  </Button>
                ...
                <Card className="bg-card border-border">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex justify-between items-center py-2 border-b border-border">
                      ...
                      <span className="font-semibold text-primary">1:30</span>
                    </div>
                    <div className="flex justify-between items-center py-2">
                      <span className="text-muted-foreground text-sm">Platformlar</span>
                      <span className="font-semibold text-foreground">eToro</span>
                    </div>
                  </CardContent>
                </Card>
              </div>
      ...
      <section className="py-8 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900">
        <div className="container mx-auto px-4">
          <a
            ...
            onClick={() => trackTRBrokerClick("etoro", "tr_review_commission_banner", "click")}
          ...
          >
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">
              <span className="text-yellow-400">CopyTrader</span> ile Otomatik İşlem
            </h2>
            <p className="text-xl text-white mb-4">
              Başarılı yatırımcıları <span className="text-yellow-400">kopyalayın!</span>
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="p-6 bg-primary/5 border border-primary/20 rounded-2xl text-center">
              <p className="text-foreground font-semibold mb-2">
                eToro ile sosyal trading dünyasına adım atın
              </p>
              <p className="text-sm text-muted-foreground mb-4">
                $50 minimum depozito · CopyTrader · Forex + Kripto + Hisse
              </p>
              <Button size="lg" asChild>
                <a href={broker.siteUrl} target="_blank" rel="noopener noreferrer"
                   onClick={() => trackTRBrokerClick("etoro", "tr_review_pros_cons", "hesap_ac")}>
                  eToro'da Hesap Aç <ExternalLink className="w-4 h-4 ml-2" />
                </a>
              </Button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xs text-muted-foreground mt-4">
              * Profesyonel hesap için deneyim ve portföy büyüklüğü şartları geçerlidir.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none">
              <p>
                eToro, özellikle sosyal trading ve copy trading ile ilgilenen yatırımcılar için
                eşsiz bir platformdur. CopyTrader özelliği sayesinde deneyimli yatırımcıların
                stratejilerini otomatik olarak kopyalayabilirsiniz.
              </p>
              <p>
                Forex, kripto, hisse ve ETF'leri tek platformda sunması büyük bir avantajdır.
                Ancak spread'ler bazı rakiplerden yüksek olabilir ve MT4/MT5 desteği yoktur.
              </p>
              <p className="font-semibold">
                Tavsiye: Sosyal trading ve çoklu varlık yatırımı yapmak isteyenler için mükemmel bir seçim.
              </p>
            </div>
            <div className="grid grid-cols-3 gap-3 mt-6 mb-6">
              <div className="p-3 bg-green-50 dark:bg-green-950/30 rounded-lg border border-green-200 dark:border-green-800">
                <p className="text-xs font-semibold text-green-700 dark:text-green-400 mb-1">Uygun</p>
                <p className="text-xs text-green-600 dark:text-green-500">Yeni başlayanlar<br/>Copy trading meraklıları</p>
              </div>
              <div className="p-3 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-800">
                <p className="text-xs font-semibold text-blue-700 dark:text-blue-400 mb-1">İdeal</p>
                <p className="text-xs text-blue-600 dark:text-blue-500">Çoklu varlık yatırımcıları<br/>Sosyal trading kullanıcıları</p>
              </div>
              <div className="p-3 bg-red-50 dark:bg-red-950/30 rounded-lg border border-red-200 dark:border-red-800">
                <p className="text-xs font-semibold text-red-700 dark:text-red-400 mb-1">Uygun Değil</p>
                <p className="text-xs text-red-600 dark:text-red-500">MT4/MT5 kullananlar<br/>Yüksek kaldıraç arayanlar</p>
              </div>
            </div>

            <div className="mt-2">
              <Button size="lg" asChild>
                <a href={broker.siteUrl} target="_blank" rel="noopener noreferrer" onClick={() => trackTRBrokerClick("etoro", "tr_review_bottom", "hesap_ac")}>
                  eToro'da Hesap Aç <ExternalLink className="w-4 h-4 ml-2" />
                </a>
              </Button>
            </div>
