...
const OANDAInceleme = () => {
  ...
  useEffect(() => {
    trackTRPageView("oanda", "review");
  }, []);

  const ratings = [
    { label: "İşlem Koşulları", score: 3.8 },
    { label: "Platform ve Araçlar", score: 4.2 },
  ...
  const pros = [
    "CFTC/NFA regülasyonlu — en üst düzey güvenlik",
    "Minimum depozito yok ($0)",
    "1996'dan beri faaliyet gösteren köklü broker",
    "Gelişmiş grafik ve analiz araçları",
    "MT4 desteği mevcut",
    "ACH ve banka havalesi ücretsiz",
    "Negatif bakiye koruması",
  ];

  const cons = [
    "Düşük kaldıraç (1:50 maksimum)",
    "Spread'ler bazı rakiplerden yüksek",
    "Platform tasarımı biraz eski",
    "Kripto ile para yatırma yok",
    "Türkçe destek sınırlı",
  ];

  return (
    <TRLayout
      title="OANDA İnceleme 2026 - Detaylı Broker Analizi"
      description="OANDA broker detaylı inceleme. CFTC/NFA regülasyonlu, $0 minimum depozito, 1:50 kaldıraç. 1996'dan beri güvenilir broker."
      keywords="oanda broker, oanda inceleme, oanda türkiye, oanda minimum depozito, oanda kaldıraç"
    >
      {/* Hero Section */}
            ...
            <div className="flex flex-col lg:flex-row items-start gap-8">
              <div className="flex-1">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-4">
                  ...
                  <span className="text-sm text-primary font-medium">CFTC/NFA Regülasyonlu</span>
                </div>

                <div className="flex items-center gap-4 mb-4">
                  <BrokerLogo broker={broker} className="w-20 h-20 rounded-2xl" imgClassName="p-2" />
                  <div>
                    <h1 className="font-heading text-3xl md:text-4xl font-bold text-foreground">OANDA İnceleme</h1>
                    <p className="text-muted-foreground mt-1">1996'dan beri güvenilir forex broker</p>
                  </div>
                </div>
                ...
                <p className="text-muted-foreground mb-6">
                  OANDA, 1996 yılında kurulan ve ABD'de CFTC/NFA tarafından düzenlenen köklü bir forex
                  brokeridir. $0 minimum depozito ile başlamak mümkündür. Gelişmiş analiz araçları ve
                  güvenilir altyapısı ile hem yeni başlayanlar hem de deneyimli yatırımcılar için uygundur.
                </p>

                <div className="flex flex-wrap gap-3">
                  <Button size="lg" asChild>
                    <a href={broker.siteUrl} target="_blank" rel="noopener noreferrer" onClick={() => trackAffiliateClick("oanda", "tr_review_hero", "visit_site")}>
                      OANDA'yı Ziyaret Et <ExternalLink className="w-4 h-4 ml-2" />
                    </a>
                  </Button>
                ...
                <Card className="bg-card border-border">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex justify-between items-center py-2">
                      ...
                      <span className="font-semibold text-foreground">OANDA, MT4</span>
                    </div>
                  </CardContent>
                </Card>
              </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="p-6 bg-primary/5 border border-primary/20 rounded-2xl text-center">
              <p className="text-foreground font-semibold mb-2">
                OANDA, CFTC/NFA regülasyonlu güvenilir bir broker
              </p>
              <p className="text-sm text-muted-foreground mb-4">
                $0 minimum depozito · 1996'dan beri · Gelişmiş analiz araçları
              </p>
              <Button size="lg" asChild>
                <a href={broker.siteUrl} target="_blank" rel="noopener noreferrer"
                   onClick={() => trackTRBrokerClick("oanda", "tr_review_pros_cons", "hesap_ac")}>
                  OANDA'da Hesap Aç <ExternalLink className="w-4 h-4 ml-2" />
                </a>
              </Button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none">
              <p>
                OANDA, güvenilirlik ve düzenleyici uyumluluk konusunda sektörün en iyilerinden biridir.
                1996'dan beri faaliyet gösteren broker, CFTC ve NFA düzenlemelerine tabidir ve
                minimum depozito gerektirmez.
              </p>
              <p>
                Kaldıraç limitleri düşük olsa da (1:50), bu ABD düzenlemelerinin bir gereğidir ve
                aslında yatırımcıları aşırı riskten korur. Gelişmiş analiz araçları ve MT4 desteği
                ile hem yeni başlayanlar hem de profesyoneller için uygundur.
              </p>
              <p className="font-semibold">
                Tavsiye: Güvenilirliğe öncelik veren ve düşük riskli işlem yapmak isteyen yatırımcılar için idealdir.
              </p>
            </div>
            <div className="grid grid-cols-3 gap-3 mt-6 mb-6">
              <div className="p-3 bg-green-50 dark:bg-green-950/30 rounded-lg border border-green-200 dark:border-green-800">
                <p className="text-xs font-semibold text-green-700 dark:text-green-400 mb-1">Uygun</p>
                <p className="text-xs text-green-600 dark:text-green-500">Yeni başlayanlar<br/>Güvenilirlik arayanlar</p>
              </div>
              <div className="p-3 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-800">
                <p className="text-xs font-semibold text-blue-700 dark:text-blue-400 mb-1">İdeal</p>
                <p className="text-xs text-blue-600 dark:text-blue-500">Uzun vadeli yatırımcılar<br/>Analiz odaklı</p>
              </div>
              <div className="p-3 bg-red-50 dark:bg-red-950/30 rounded-lg border border-red-200 dark:border-red-800">
                <p className="text-xs font-semibold text-red-700 dark:text-red-400 mb-1">Uygun Değil</p>
                <p className="text-xs text-red-600 dark:text-red-500">Yüksek kaldıraç arayanlar<br/>Kripto ile yatırım yapanlar</p>
              </div>
            </div>

            <div className="mt-2">
              <Button size="lg" asChild>
                <a href={broker.siteUrl} target="_blank" rel="noopener noreferrer" onClick={() => trackTRBrokerClick("oanda", "tr_review_bottom", "hesap_ac")}>
                  OANDA'da Hesap Aç <ExternalLink className="w-4 h-4 ml-2" />
                </a>
              </Button>
            </div>
